    ...
    <div>
        ...
        <div className="tc fl w-100">
              ...
              <div className=' grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3 fl w-25 mymeasure'>
                   <img className='mysize_item' src="http://halalscience.ph/static/img/service/lab/1.jpg" alt=""/>
               ...
               <div className=' grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3 fl w-25 mymeasure'>
                   <img className='mysize_item' src="http://halalscience.ph/static/img/service/lab/2.jpg" alt=""/>
               ...
               <div className=' grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3 fl w-25 mymeasure'>   
                   <img className='mysize_item' src="http://halalscience.ph/static/img/service/lab/3.jpg" alt=""/>
                ...
                <div className=' grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3 fl w-25 mymeasure'>
                   <img className='mysize_item' src="http://halalscience.ph/static/img/service/lab/4.jpg" alt=""/>
        ...
        <div className="tc fl w-100">
              ...
              <div className=' grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3 fl w-25 mymeasure'>
                   <img className='mysize_item' src="http://halalscience.ph/static/img/service/lab/5.jpg" alt=""/>
               ...
               <div className=' grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3 fl w-25 mymeasure'>
                   <img className='mysize_item' src="http://halalscience.ph/static/img/service/lab/6.jpg" alt=""/>
               ...
               <div className=' grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3 fl w-25 mymeasure'>   
                   <img className='mysize_item' src="http://halalscience.ph/static/img/service/lab/7.jpg" alt=""/>
                ...
                <div className=' grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3 fl w-25 mymeasure'>
                   <img className='mysize_item' src="http://halalscience.ph/static/img/service/lab/8.jpg" alt=""/>
