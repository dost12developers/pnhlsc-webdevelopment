  ...
  return (
    <div className='tc grow bg-light-green br3 pa3 ma2 dib bw2 shadow-3'>
     <div className="parent">
      <img alt='products' src={`http://localhost:8080/static/img/product/${codefilename}.jpg`} height='200px' width='200px'/>
      <img alt='' className='over-img' src={`http://localhost:8080/static/img/logo/${logofilename}.png`} height='30px' width='30px'/>
      </div>
      <div>
